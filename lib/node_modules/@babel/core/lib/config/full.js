...
const loadDescriptor = (0, _caching.makeWeakCache)((_ref2, cache) => {
  let {
    value,
    options,
    dirname,
...
const instantiatePlugin = (0, _caching.makeWeakCache)((_ref3, cache) => {
  let {
    value,
    options,
    dirname,
...
const instantiatePreset = (0, _caching.makeWeakCache)((_ref4) => {
  let {
    value,
    dirname,
    alias

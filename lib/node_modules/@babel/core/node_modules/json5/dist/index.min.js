...
function invalidChar(u) {
  return syntaxError(void 0 === u ? "JSON5: invalid end of input at ".concat(line, ":").concat(column) : "JSON5: invalid character '".concat(formatChar(u), "' at ").concat(line, ":").concat(column));
}
...
function invalidIdentifier() {
  return syntaxError("JSON5: invalid identifier character at ".concat(line, ":").concat(column -= 5));
}
...
var stringify = function stringify(u, D, e) {
  const r = [];
  let t,
      F,
      C,
